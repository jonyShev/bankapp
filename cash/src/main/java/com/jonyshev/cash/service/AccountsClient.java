...
public class AccountsClient {
    ...
    public boolean add(String login, String currency, String amount) {
        return postWithParams("/add", login, currency, amount);
    }

    public boolean sub(String login, String currency, String amount) {
        return postWithParams("/sub", login, currency, amount);
    }

    private boolean postWithParams(String path, String login, String currency, String amount) {
